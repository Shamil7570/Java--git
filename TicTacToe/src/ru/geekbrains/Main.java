...
public class Main {
    ...
    //переписал логику победы, разобрался с кодом, понимаю какие методы и что делают, но сам написать не могу,
    //для меня на данном этапе это сложно, а создать ИИ для меня сейчас что-то нереальное, моя логика такова,
    // когда игрок ставит 2 фишки подрят, то копм на 3-ю позицию ставит свою фишку, тем самым блокируя комбинацию игрока
    //но как это реальзовать в коды я не знаю
